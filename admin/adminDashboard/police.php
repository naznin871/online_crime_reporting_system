<?php include "header.php"; ?>
  <div id="admin-content">
      <div class="container">
          <div class="row">
              <div class="col-md-7">
                  <h1 class="admin-heading">Register Police</h1>
              </div>
              ...
              <div class="col-md-2" >
                  <a class="add-new" href="add_police.php">add Police</a>
              </div>
              <div class="col-md-12">
  ...
  while($row=mysqli_fetch_assoc($result)){
    ...
    ?>
                          <tr>
                              ...
                              <td class='edit'><a href='update_police.php?id=<?php echo  $row['user_id']; ?>'><i class='fa fa-edit'></i></a></td>
                              <td class='delete'><a onclick="return confirm(
                              'Are you sure want to delete?')" href='delete_police.php?id=<?php echo  $row['user_id']; ?>'><i class='fa fa-trash-o'></i></a></td>
                          </tr>
  <?php  } ?>
                      </tbody>
  <?php } ?>
...
if(mysqli_num_rows($result1)){
  ...
  if($page_number>1){
    echo '<li><a href="police.php?page='.($page_number-1).'"><b><<</b></a></li>';
  }
  for($i=1; $i<=$total_page; $i++){
    ...
    echo'<li class='.$active.'><a href="police.php?page='.$i.'">'.$i.'</a></li>';
  }
